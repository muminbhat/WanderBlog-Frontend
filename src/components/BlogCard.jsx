...
const BlogCard = () => {
  ...
  useEffect(() => {
    ...
    return (
        <>
  <div className="max-w-screen-xl mx-auto p-4 sm:p-10 md:p-16">
...
{blogEntry.info.slice(0, 150)+'...'}
        ...
        <div className="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
          ...
          >
            ...
            <span className="ml-1">{blogEntry.read_time} min read</span>
          </span>
          <span
            href="/"
            className="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center"
